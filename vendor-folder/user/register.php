...
//             if(mysqli_stmt_execute($stmt)){
//                 // Redirect to login page
//                 header("location: ../pages/vendor-login.php");
//             } else{
//                 echo "Oops! Something went wrong. Please try again later.";
//             }
...
<head>
    <meta charset="UTF-8">
    <title>Sign Up</title>
    <db$db rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <style>
        body{ font: 14px sans-serif; }
        .wrapper{ width: 360px; padding: 20px; }
    </style>
...
<body>
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                <label>Password</label>
                <input type="password" name="vendor_password" class="form-control <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $password; ?>">
                <span class="invalid-feedback"><?php echo $password_err; ?></span>
            </div>
            <div class="form-group">
                <label>Confirm Password</label>
