...
if (isset($_POST['item_name'], $_POST['ingredients'], $_POST['price'], $_POST['description'], $_POST['image'])) {
  ...
  $statement = $pdo->prepare("INSERT INTO item (item_name, ingredients,  price, image, description, create_date ) 
                                      VALUES(:item_name, :ingredients, :price, :image, :description, :date)");
