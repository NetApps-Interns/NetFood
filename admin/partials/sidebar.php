...
<li class="nav-item accordion-content hide">
<h3 class="title"><i class='fas fa-user-cog'></i> Manage</h3>
<ul class="description navbar-nav">
  <li class="nav-item">
      <a class="nav-link content-link" href="dashboard.php?cat=pages&subcat=customer">Customers</a>
    </li>
    <li class="nav-item">
      <a class="nav-link content-link" href="dashboard.php?cat=pages&subcat=vendor">Vendors</a>
    </li>
    <li class="nav-item">
